...
/**
 * 竞价供应商物品(PaidVendorMaterial)表更新入参DTO类
 *
 * @author Fish.Fei
...
public class PaidVendorMaterialDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = 467554161639164911L;
