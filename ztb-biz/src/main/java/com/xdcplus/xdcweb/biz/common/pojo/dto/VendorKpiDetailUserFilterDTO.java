...
/**
 * 供应商绩效人员评价表(VendorKpiDetailUser)表查询入参DTO类
 *
 * @author makejava
...
public class VendorKpiDetailUserFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 144035429299345067L;
