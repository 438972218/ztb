...
/**
 * 供应商现场考察人员表(VendorSiteInsUser)表实体类
 *
 * @author makejava
...
@TableName("scm_vendor_site_ins_user")
public class VendorSiteInsUser implements Serializable {
    private static final long serialVersionUID = 642454338067159312L;
