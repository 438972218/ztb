...
/**
 * 评分要素(BidScoringElements)表查询条件类
 *
 * @author Fish.Fei
...
public class BidScoringElementsQuery implements Serializable {
    private static final long serialVersionUID = 558341360427438357L;
