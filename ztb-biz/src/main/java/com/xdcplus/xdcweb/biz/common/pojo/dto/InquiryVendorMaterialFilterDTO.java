...
/**
 * 询价供应商物品(InquiryVendorMaterial)表查询入参DTO类
 *
 * @author Fish.Fei
...
public class InquiryVendorMaterialFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 261876334524759343L;
