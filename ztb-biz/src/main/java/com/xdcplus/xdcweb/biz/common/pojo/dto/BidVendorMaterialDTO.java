...
/**
 * 招标投标方物品(BidVendorMaterial)表更新入参DTO类
 *
 * @author Fish.Fei
...
public class BidVendorMaterialDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = 581780072843581787L;
