...
/**
 * 供应商合格评审表明细(VendorQualifyReviewDetail)表查询入参DTO类
 *
 * @author makejava
...
public class VendorQualifyReviewDetailFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 890880298969263117L;
