...
/**
 * 供应商合格评审表(VendorQualifyReview)表实体类
 *
 * @author Fish.Fei
...
@TableName("scm_vendor_qualify_review")
public class VendorQualifyReview implements Serializable {
    private static final long serialVersionUID = 690129288346046124L;
