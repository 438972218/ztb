...
/**
 * 供应商现场考察表明细(VendorSiteInsDetail)表更新入参DTO类
 *
 * @author makejava
...
public class VendorSiteInsDetailDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = -31670773078418540L;

    @ApiModelProperty("信息主键")
    private Long id;

    @NotNull(message = "现场评审表ID不能为空")
