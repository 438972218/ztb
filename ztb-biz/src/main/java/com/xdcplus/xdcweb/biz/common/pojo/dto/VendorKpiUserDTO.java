...
/**
 * 供应商绩效人员表(VendorKpiUser)表更新入参DTO类
 *
 * @author makejava
...
public class VendorKpiUserDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = 625830183504816493L;
