...
@TableName("scm_vendor_site_ins")
public class VendorSiteIns implements Serializable {
    private static final long serialVersionUID = -15636958178086503L;
