...
public class VendorRequestVO extends BaseBO implements Serializable {
    private static final long serialVersionUID = 351022926832767594L;
    ...
    private List<VendorRequestCertificateVO> vendorRequestCertificateVOS;
