...
/**
 * 供应商注册单(VendorRequest)表查询入参DTO类
 *
 * @author makejava
...
public class VendorRequestFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 694422918168441915L;
