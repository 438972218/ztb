...
/**
 * 竞价供应商物品(PaidVendorMaterial)表查询条件类
 *
 * @author Fish.Fei
...
public class PaidVendorMaterialQuery implements Serializable {
    private static final long serialVersionUID = -26341182725631980L;
