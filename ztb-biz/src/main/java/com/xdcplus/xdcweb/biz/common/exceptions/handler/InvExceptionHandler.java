package com.xdcplus.xdcweb.biz.common.exceptions.handler;
...
public class InvExceptionHandler {
     ...
     */
    @ExceptionHandler(value = InvException.class)
    public Response InvExceptionHandler(InvException e) {

        log.error("invExceptionHandler  {}", e.getMessage());
