...
/**
 * 供应商现场考察表(VendorSiteIns)表查询入参DTO类
 *
 * @author makejava
...
public class VendorSiteInsFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = -92785573041747698L;
