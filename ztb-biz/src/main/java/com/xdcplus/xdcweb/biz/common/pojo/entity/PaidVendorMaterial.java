...
/**
 * 竞价供应商物品(PaidVendorMaterial)表实体类
 *
 * @author Fish.Fei
...
@TableName("scm_paid_vendor_material")
public class PaidVendorMaterial implements Serializable {
    private static final long serialVersionUID = 728557933262002017L;
