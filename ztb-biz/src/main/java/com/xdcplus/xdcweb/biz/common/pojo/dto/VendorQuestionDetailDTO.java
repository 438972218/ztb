...
/**
 * 供应商电子调查表明细(VendorQuestionDetail)表更新入参DTO类
 *
 * @author makejava
 * @since 2021-07-14 14:51:20
 */
@Data
@EqualsAndHashCode(callSuper = true)
@ApiModel(description = "")
@SuppressWarnings("serial")
public class VendorQuestionDetailDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = 506168807765376186L;
