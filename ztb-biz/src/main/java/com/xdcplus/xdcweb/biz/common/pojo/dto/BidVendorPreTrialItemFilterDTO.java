...
/**
 * 招标投标方预审项(BidVendorPreTrialItem)表查询入参DTO类
 *
 * @author Fish.Fei
...
public class BidVendorPreTrialItemFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 168261562242086340L;
