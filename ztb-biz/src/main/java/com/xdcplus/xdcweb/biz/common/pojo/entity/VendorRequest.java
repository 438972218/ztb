...
/**
 * 供应商注册单(VendorRequest)表实体类
 *
 * @author makejava
 * @since 2021-07-26 15:31:56
 */
@Data
@EqualsAndHashCode(callSuper = true)
@ApiModel(description = "")
@SuppressWarnings("serial")
@TableName("scm_vendor_request")
public class VendorRequest extends Model<VendorRequest> implements Serializable {
    private static final long serialVersionUID = -31415381412558295L;
