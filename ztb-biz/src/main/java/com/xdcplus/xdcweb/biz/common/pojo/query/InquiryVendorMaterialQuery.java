...
/**
 * 询价供应商物品(InquiryVendorMaterial)表查询条件类
 *
 * @author Fish.Fei
...
public class InquiryVendorMaterialQuery implements Serializable {
    private static final long serialVersionUID = -84166103619705734L;
